				...
				switch (noteType)
					{
						...
						case 2:
							trace('note type 2');
							animation.addByPrefix('greenScroll', 'green star');
							animation.addByPrefix('redScroll', 'red star');
							animation.addByPrefix('blueScroll', 'blue star');
							animation.addByPrefix('purpleScroll', 'purple star');
						case 3:
							trace('note type 3');
							animation.addByPrefix('greenScroll', 'green sword');
							animation.addByPrefix('redScroll', 'red sword');
							animation.addByPrefix('blueScroll', 'blue sword');
							animation.addByPrefix('purpleScroll', 'purple sword');
						default:
